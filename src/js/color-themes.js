...
var colorTheme = {
    ...
    init: function(){
        ...
        $('[data-reset]').on('resetColors', function () {
            ...
            cookie.set(self.COOKIE_THEME, 'default');
            self.setActiveItem('default');
        });
    },
    curCookieTheme: function(){
        var curCookieTheme = cookie.get(this.COOKIE_THEME);
        if (curCookieTheme) {
    ...
    setTheme: function(theme){
        ...
        if (cookie.get(this.COOKIE_THEME) !== theme) {
            cookie.set(this.COOKIE_THEME, theme);
        }
    },
